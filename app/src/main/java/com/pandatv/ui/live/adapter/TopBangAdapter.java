...
public class TopBangAdapter extends BaseAdapter {
    private Context context;
    private List<TopBangBean.VideoBean> list;

    public TopBangAdapter(Context context, List<TopBangBean.VideoBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TopBangBean.VideoBean videoBean = list.get(position);
