...
public class ThoseThingAdapter extends BaseAdapter {
    private Context context;
    private List<ThoseThingBean.VideoBean> list;

    public ThoseThingAdapter(Context context, List<ThoseThingBean.VideoBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ThoseThingBean.VideoBean videoBean = list.get(position);
