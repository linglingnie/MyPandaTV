...
public class SpecialProgramAdapter extends BaseAdapter {
    private Context context;
    private List<SpecialProgramBean.VideoBean> list;

    public SpecialProgramAdapter(Context context, List<SpecialProgramBean.VideoBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SpecialProgramBean.VideoBean videoBean = list.get(position);
