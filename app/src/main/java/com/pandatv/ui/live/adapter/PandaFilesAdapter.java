...
public class PandaFilesAdapter extends BaseAdapter {
    private Context context;
    private List<PandaFiesBean.VideoBean> list;

    public PandaFilesAdapter(Context context, List<PandaFiesBean.VideoBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PandaFiesBean.VideoBean videoBean = list.get(position);
