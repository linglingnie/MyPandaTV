...
public class WhenNoLetBean implements Parcelable {
    ...
    public WhenNoLetBean() {
    }

    protected WhenNoLetBean(Parcel in) {
    ...
    public static final Parcelable.Creator<WhenNoLetBean> CREATOR = new Parcelable.Creator<WhenNoLetBean>() {
        @Override
        public WhenNoLetBean createFromParcel(Parcel source) {
            return new WhenNoLetBean(source);
        }

        @Override
        public WhenNoLetBean[] newArray(int size) {
            return new WhenNoLetBean[size];
        }
    };
}
