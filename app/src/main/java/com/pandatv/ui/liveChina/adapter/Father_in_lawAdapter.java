...
public class Father_in_lawAdapter extends BaseAdapter {

    private Context context;
    private List<Father_in_lawBean.LiveBean> list;

    public Father_in_lawAdapter(Context context, List<Father_in_lawBean.LiveBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Father_in_lawBean.LiveBean liveBean = list.get(position);
