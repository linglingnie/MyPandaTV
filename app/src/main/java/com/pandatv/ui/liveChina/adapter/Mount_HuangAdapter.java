...
public class Mount_HuangAdapter extends BaseAdapter {

    private Context context;
    private List<Mount_HuangBean.LiveBean> list;

    public Mount_HuangAdapter(Context context, List<Mount_HuangBean.LiveBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Mount_HuangBean.LiveBean liveBean = list.get(position);
